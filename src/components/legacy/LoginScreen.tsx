...
function Truss() {
  return (
    <div className="flex items-baseline relative" style={{ height: '300px', marginTop: '100px', fontFamily: 'sans-serif', justifyContent: 'center', transform: 'translateX(-1px)' }}>
      <div className="relative" style={{ zIndex: 2 }}>
        <div className="rounded" style={{ width: '12px', height: '90px', backgroundColor: '#5dbbff', marginLeft: '50px' }} />
        <div id="t-bar-axis" className="absolute" style={{ top: '6px', left: '56px', width: '0', height: '0' }}>
          <div className="absolute rounded-md" style={{ left: '-55px', top: '-6px', width: '280px', height: '12px', backgroundColor: '#5dbbff' }} />
...
export function LoginScreen({ onLogin, onAdminLogin, language, onLanguageChange }: LoginScreenProps) {
  return (
    <div onClick={onLogin} className="cursor-pointer w-full h-screen relative bg-[#F5F1E8] flex flex-col items-center justify-center">
